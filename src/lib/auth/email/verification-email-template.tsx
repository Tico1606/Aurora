...
export function renderVerificationEmail(name: string, verificationUrl: string) {
  const contentHtml = `
    ...
    <p style="margin:28px 0 0;font-size:13px;line-height:1.6;color:${EMAIL_BRAND_MUTED};">Se voce nao solicitou este cadastro, ignore este email.</p>
  `

  return renderEmailLayout({
    preheader: `Confirme sua conta na ${EMAIL_BRAND_NAME} para ativar seu acesso.`,
    title: 'Confirmacao de conta',
    contentHtml,
  })
}
